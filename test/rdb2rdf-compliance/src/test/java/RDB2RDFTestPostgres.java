...
public class RDB2RDFTestPostgres {
	/**
	 * Only run the following tests. Skip others.
	 */
	private static final Set<String> ONLY = ImmutableSet.of();//"dg0011","dg0014","dg0021","dg022","dg0023","dg0024","dg0025");
	/**
...
//			"tc0019a"
	...
	private static Properties PROPERTIES;
	  ...
	  private static final String JDBC_URL = "jdbc:postgresql://:7777/Rdb2RdfTest";
	  private static final String DB_USER = "postgres";
	  private static final String DB_PASSWORD = "postgres2";
		...
		for (int i = 0; i < 26; i++) {
            ...
            RDFHandler manifestHandler = new AbstractRDFHandler() {
				...
				private void createTestCase() {
					if (name != null && ONLY.isEmpty() || ONLY.contains(name)) {
	...
	private static URL url(String path)  {
		return path == null ? null : RDB2RDFTestPostgres.class.getResource(path);
	}

	private static InputStream stream(String path) {
		return RDB2RDFTestPostgres.class.getResourceAsStream(path);
	}
	...
	static final Logger logger = LoggerFactory.getLogger(RDB2RDFTestPostgres.class);
	...
	public void beforeTest() throws Exception {
		...
		SQL_CONN = DriverManager.getConnection(JDBC_URL, DB_USER, DB_PASSWORD);
	...
	protected static void clearDB()  {
        ...
        try (java.sql.Connection pgConnection = DriverManager.getConnection(JDBC_URL.replace("Rdb2RdfTest", "postgres"), DB_USER, DB_PASSWORD);
